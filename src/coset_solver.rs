...
//     coset_cube: CosetIndex,
//     depth: u8,
//     stack: Vec<TwistSet>,
// }

// impl<'a> CosetToSubsetPathsIterator<'a> {
//     pub fn new(twister: &'a Twister, phase_1: &'a DirectionsTable, coset_cube: CosetIndex) -> Self {
...
//             max_solution_length,
//             coset_cube: CosetIndex::solved(),
//             coset: (0..SubsetIndex::INDEX_SIZE).map(|_| AtomicBool::new(false)).collect(),
//         }
//     }

//     pub fn reset_for(&mut self, coset_cube: CosetIndex) {
...
//         (0..SubsetIndex::INDEX_SIZE).into_par_iter().for_each(|subset_index| {
...
//         println!("Covered {} ({}%) elements in {:?}", count, count as f64 * 100.0 / SubsetIndex::INDEX_SIZE as f64, start.elapsed());
//     }
// }
