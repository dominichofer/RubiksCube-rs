...
//                     e_slice_prm =
//                         self.twister
//                             .twisted_e_slice_prm(e_slice_prm, e_slice_loc, *twist);
...
//                     e_non_slice_prm =
//                         self.twister
//                             .twisted_e_non_slice_prm(e_non_slice_prm, e_slice_loc, *twist);
//                     e_slice_loc = self.twister.twisted_e_slice_loc(e_slice_loc, *twist);
//                 }
...
// //         let mut rnd_full = RandomTwistGen::new(42, &ALL_TWISTS);
// //         let mut rnd_h0 = RandomTwistGen::new(42, &H0_TWISTS);
// //         for _ in 0..5 {
...
// //                 assert_eq!(
// //                     multi_twister.twisted_c_prm(subset_prm),
// //                     coset_cube.prm_index()
// //                 );
// //                 assert_eq!(
// //                     multi_twister.twisted_c_ori(subset_ori),
// //                     coset_cube.ori_index()
// //                 );
// //             }
// //         }
// //     }
...
// //         let mut multi_twister = MultiTwister::new(&twister);
// //         let mut rnd_full = RandomTwistGen::new(42, &ALL_TWISTS);
// //         let mut rnd_h0 = RandomTwistGen::new(43, &H0_TWISTS);
// //         for _ in 0..5 {
// //             let twists = rnd_full.gen_twists(15);
// //             let foo = Edges::
// //             multi_twister.set_for(&twists);
...
// //             for _ in 0..1000 {
// //                 let twist_h0 = Edges::twist(rnd_h0.gen_twist());
// //                 subset_cube = twist_h0 * subset_cube;
// //                 let subset_ori = subset_cube.ori_index();
...
// //                 assert_eq!(
// //                     multi_twister.twisted_e_ori(subset_ori),
// //                     subset_cube.twisted_by(&twists).ori_index()
// //                 );
// //                 assert_eq!(
// //                     multi_twister.twisted_e_slice_prm(subset_slice_prm),
// //                     subset_cube.twisted_by(&twists).slice_prm_index()
// //                 );
// //                 assert_eq!(
// //                     multi_twister.twisted_e_non_slice_prm(subset_non_slice_prm),
// //                     subset_cube.twisted_by(&twists).non_slice_prm_index()
// //                 );
// //                 assert_eq!(
// //                     multi_twister.twisted_e_slice_loc(subset_slice_loc),
// //                     subset_cube.twisted_by(&twists).slice_loc_index()
// //                 );
// //             }
// //         }
// //     }
